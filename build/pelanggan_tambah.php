...
if (isset($_POST['nama_pelanggan'])) {
   ...
   if ($query) {
      // Tidak perlu mengambil data dengan mysqli_fetch_array pada query INSERT,
      // karena query INSERT tidak mengembalikan result set.
      // Jika ingin menyimpan data pelanggan ke session, gunakan data dari $_POST saja.
      $_SESSION['pelanggan'] = [
         'nama_pelanggan' => $nama,
         'alamat' => $alamat,
