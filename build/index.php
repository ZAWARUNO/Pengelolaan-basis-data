...
if (isset($_SESSION['login_success']) && $_SESSION['login_success'] === true) {
  echo '<div id="successAlert" class="fixed top-4 left-0 right-0 mx-auto w-full max-w-md z-999999 rounded-xl border border-success-500 bg-success-50 p-4 dark:border-success-500/30 dark:bg-success-500/15">
    <div class="flex items-start gap-3">
      ...
      <div>
        <h4 class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Login Berhasil</h4>
        <p class="text-sm text-gray-500 dark:text-gray-400">' . $_SESSION['login_message'] . '</p>
      </div>
    </div>
  </div>
  <script>
...
<body
  x-data="{ page: 'ecommerce', 'loaded': true, 'darkMode': false, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false, 'isOpen': false, 'isProfileAddressModal': false}"
  x-init="
