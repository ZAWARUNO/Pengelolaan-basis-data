...
if (isset($_POST['username'])) {
  ...
  if (mysqli_num_rows($cek) > 0) {
    ...
    $_SESSION['login_message'] = 'Selamat datang kembali ' . $data['username'];
    ...
    echo '<div id="errorAlert" class="fixed top-4 left-0 right-0 mx-auto w-full max-w-md z-9999 rounded-xl border border-warning-500 bg-warning-50 p-4 dark:border-warning-500/30 dark:bg-warning-500/15">
      <div class="flex items-start gap-3">
        ...
        <div>
          <h4 class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Login Gagal</h4>
          <p class="text-sm text-gray-500 dark:text-gray-400">Username atau password yang anda masukkan salah</p>
        </div>
      </div>
    </div>
    <script>
...
if (isset($_SESSION['signup_success']) && $_SESSION['signup_success'] === true) {
  echo '<div id="successAlert" class="fixed top-4 left-0 right-0 mx-auto w-full max-w-md z-999999 rounded-xl border border-success-500 bg-success-50 p-4 dark:border-success-500/30 dark:bg-success-500/15">
    <div class="flex items-start gap-3">
      ...
      <div>
        <h4 class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Sign Up Berhasil</h4>
        <p class="text-sm text-gray-500 dark:text-gray-400">' . $_SESSION['signup_message'] . '</p>
      </div>
    </div>
  </div>
  <script>
          ...
          <div>
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Masukan Useername dan Password Untuk Signin!
              </p>
            </div>
            <div>
        ...
        <div class="flex items-center justify-center z-1">
          ...
          <div class="flex flex-col items-center max-w-xs">
            ...
            <p class="text-center text-gray-400 dark:text-white/60">
              Selamat datang Para pekerja! Semangat kerja yah 😋
            </p>
          </div>
        </div>
      </div>
