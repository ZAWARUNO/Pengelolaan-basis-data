...
if (isset($_POST['nama_produk'])) {
    ...
    <div class="flex items-start gap-3">
      ...
      <div>
        <h4 class="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Tambah Produk Berhasil</h4>
        <p class="text-sm text-gray-500 dark:text-gray-400">Produk ' . $nama . ' berhasil ditambahkan</p>
      </div>
    </div>
  </div>
  <script>
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <span
                                            class="absolute top-1/2 left-0 -translate-y-1/2 border-r border-gray-200 px-3.5 py-3 text-gray-500 dark:border-gray-800 dark:text-gray-400">
                                            <svg fill="#000000" width="20px" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M19,23a1,1,0,0,0,1-1V8a1,1,0,0,0-.349-.759l-7-6a1,1,0,0,0-1.3,0l-7,6A1,1,0,0,0,4,8V22a1,1,0,0,0,1,1ZM6,8.46l6-5.143L18,8.46V21H6ZM14,9a2,2,0,1,1-2-2A2,2,0,0,1,14,9Z"></path></g></svg>
                                        </span>
                                        <input
                                            type="number"
                                            name="harga"
